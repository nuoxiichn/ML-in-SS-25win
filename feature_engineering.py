...
EXPERIMENT_NAME = "airfoil-noise-regression-feature-deletion"
...
def main():
    ...
    with mlflow.start_run(run_name="Airfoil_Pipeline") as parent_run:
        ...
        X = data_filt.drop(columns=['attack-angle']) # Eliminate one feature with high correlation with target to see if it improves generalization
